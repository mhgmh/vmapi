export default {
    ...
    channels: {
      ...
      form: {
        ...
        perRequestPriceRequired: 'Unit price or billing tiers required for per-request/image/video billing mode',
        defaultVideoPricePerSecond: 'Default unit price (per second)',
        perSecondUnit: '/sec',
        videoPricePerSecondHint: 'Cost = unit price × duration seconds × count. Use this mode for per-second video models.',
        tierLabel: 'Tier',
