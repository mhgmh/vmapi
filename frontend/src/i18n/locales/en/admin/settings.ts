    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          description: 'Existing users invite new ones; the inviter earns a percentage rebate on the invitee’s top-ups. Disabled by default.',
          enabled: 'Enable Affiliate',
          enabledHint: 'When off, the affiliate menu is hidden, the aff parameter is ignored at signup, and new top-ups generate no rebate. Existing rebate balances can still be transferred.',
          ...
          rebateRateHint: 'Default percentage credited to the inviter on top-ups (0-100, e.g. 10 = 10%).',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for vmapi end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for vmapi end-user login',
      ...
      defaults: {
        ...
        affiliateRebateRateHint:
          'Rebate percentage credited to the inviter after a top-up (0-100%, e.g. 10 means 10%)',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve billing rates declared by upstream vmapi sites connected to OpenAI API keys.',
      ...
      purchase: {
        title: 'Top-up / Subscription Page',
        description: 'Show an "Add Credits / Plans" entry in the sidebar and open the configured URL in an iframe',
        enabled: 'Show Top-up / Subscription Entry',
        enabledHint: 'Only shown in standard mode (not simple mode)',
        url: 'Top-up / Subscription URL',
      ...
      payment: {
        ...
        balanceRechargeMultiplier: 'Balance Top-up Multiplier',
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on vmapi orders; the upstream type is sent as EasyPay type.',
