export default {
    ...
    groups: {
      ...
      videoPricing: {
        ...
        description:
          'Configure video generation prices in USD per second. Grok defaults: 480p $0.05, 720p $0.07, 1080p $0.25; Seedance defaults: 480p $0.03, 720p $0.05, 1080p $0.08. Leave empty to use platform defaults.',
        independentMultiplier: 'Use independent video multiplier',
        videoMultiplier: 'Video multiplier',
        modeHint:
          'Videos are billed per second: per-second price × duration. Grok defaults to 1-15s (8s if omitted); Seedance may bill per-second or per-request depending on the model. By default the current effective group multiplier applies; independent mode uses the video multiplier instead.',
