export default {
    accounts: {
      ...
      types: {
        ...
        seedanceApiKey: 'Binghuo API Key',
      ...
      upstreamBilling: {
        trustWarning: 'This rate is declared by the upstream site for the current API key. vmapi cannot verify that it matches actual charges. The upstream site or an intermediary may return forged, stale, or modified data. Verify it against bills, balance changes, and actual usage.',
      ...
      seedance: {
        apiKeyOnlyHint: 'Seedance supports API Key accounts only (base_url + api_key). Default gateway: https://api.7tai.cc/v1',
      },
      grok: {
