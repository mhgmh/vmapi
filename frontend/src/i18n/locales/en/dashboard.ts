export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your vmapi Grok group.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your vmapi Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your vmapi Grok group.',
  ...
  affiliate: {
    ...
    stats: {
      ...
      rebateRateHint: 'What you earn each time an invitee tops up',
    ...
    tips: {
      ...
      line2: 'When invitees top up, you receive {rate} of the top-up as rebate credit.',
