export default {
  ...
  nav: {
    ...
    buySubscription: 'Add Credits / Plans',
    docs: 'Docs',
    myOrders: 'My Orders',
  ...
  // Auth
  auth: {
    brandEyebrow: '// ONE ENDPOINT, EVERY MODEL',
    brandHeadline: 'Route to 100+ models through a single API key.',
    brandSubline: 'OpenAI-compatible endpoint with automatic failover, per-key spend limits and real-time usage analytics.',
    ...
    promoCodeValidating: 'Validating promo code…',
    promoCodeInvalidCannotRegister: 'Invalid promo code. Fix it or clear the field to continue.',
