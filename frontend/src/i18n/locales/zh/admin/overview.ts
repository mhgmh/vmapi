export default {
    ...
    groups: {
      ...
      videoPricing: {
        title: '视频生成计费',
        description:
          '配置视频生成每秒单价（USD/秒）。Grok 默认：480p $0.05、720p $0.07、1080p $0.25；Seedance 默认：480p $0.03、720p $0.05、1080p $0.08。留空使用对应平台默认价。',
        independentMultiplier: '视频倍率独立',
        videoMultiplier: '视频独立倍率',
        modeHint:
          '视频按秒计费：费用 = 每秒价格 × 时长。Grok 默认 1-15 秒（未指定 8 秒）；Seedance 按请求/模型计费时可按秒或按次。默认叠加当前分组有效倍率；开启独立倍率后改用视频独立倍率。',
