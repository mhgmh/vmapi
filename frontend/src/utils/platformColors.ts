...
const BADGE: Record<Platform, string> = {
  ...
  seedance: 'bg-rose-500/10 text-rose-600 border-rose-500/30 dark:text-rose-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  seedance: 'bg-rose-500/10 text-rose-600 dark:bg-rose-500/10 dark:text-rose-300',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  seedance: 'bg-gradient-to-r from-rose-400 to-rose-600',
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-zinc-800 dark:text-zinc-200',
  seedance: 'text-rose-500 dark:text-rose-300',
...
const BUTTON: Record<Platform, string> = {
  ...
  seedance: 'bg-rose-600 text-white hover:bg-rose-700 active:bg-rose-800 dark:bg-rose-600/80 dark:hover:bg-rose-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  seedance: 'bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  seedance: 'from-rose-500 to-rose-700',
