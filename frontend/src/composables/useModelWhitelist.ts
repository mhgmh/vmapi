...
// Binghuo Seedance / SD2.0 video models (IDs are case-sensitive)
const seedanceModels = [
  'bh2.0-fast-480p', 'bh2.0-fast-720p',
  'bh2.0-480p', 'bh2.0-720p', 'bh2.0-1080p',
  'bh2.0-mini-480p', 'bh2.0-mini-720p',
  'SD2.0-480P', 'SD2.0-720P-fast', 'SD2.0-720P', 'SD2.0-1080P',
  'sdvip4k', 'sdvip720p', 'sdvip1080p',
  'gz-sd480p', 'gz-sd720p', 'gz-sd1080p', 'gz-sd4k',
  'sdquan-2-miao', 'wanneng1.1', 'doubaofast',
  'sd2-fast福利', 'sd2-福利',
  'B-quannengship2.0', 'quanneng2.0', 'quanneng2.0-9tu', 'video2.0',
  'sd2-vip720p', 'sd2-vip720p-fast',
  'keling-3', 'xb-sora2', 'me-kuaile1.0', 'sora-2-z', 'veo-omni-flash',
  '去字幕'
]
