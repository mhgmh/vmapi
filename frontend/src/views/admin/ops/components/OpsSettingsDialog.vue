  ...
  <BaseDialog :show="show" :title="t('admin.ops.settings.title')" width="extra-wide" @close="emit('close')">
    ...
    <div v-else-if="runtimeSettings && emailConfig && advancedSettings" class="space-y-6">
      ...
      <div class="rounded-lg bg-gray-50 p-4 dark:bg-dark-700/50">
        <h4 class="mb-3 text-sm font-semibold text-gray-900 dark:text-dark-50">{{ t('admin.ops.settings.dataCollection') }}</h4>
        <div>
      ...
      <!-- 预警配置 -->
      <div class="rounded-lg bg-gray-50 p-4 dark:bg-dark-700/50">
        <h4 class="mb-3 text-sm font-semibold text-gray-900 dark:text-dark-50">{{ t('admin.ops.settings.alertConfig') }}</h4>

        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div>
              <label class="font-medium text-gray-900 dark:text-dark-50">{{ t('admin.ops.settings.enableAlert') }}</label>
            </div>
      ...
      <!-- 评估报告配置 -->
      <div class="rounded-lg bg-gray-50 p-4 dark:bg-dark-700/50">
        <h4 class="mb-3 text-sm font-semibold text-gray-900 dark:text-dark-50">{{ t('admin.ops.settings.reportConfig') }}</h4>

        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div>
              <label class="font-medium text-gray-900 dark:text-dark-50">{{ t('admin.ops.settings.enableReport') }}</label>
            </div>
      ...
      <!-- 指标阈值配置 -->
      <div class="rounded-lg bg-gray-50 p-4 dark:bg-dark-700/50">
        <h4 class="mb-3 text-sm font-semibold text-gray-900 dark:text-dark-50">{{ t('admin.ops.settings.metricThresholds') }}</h4>
      ...
      <details class="rounded-lg bg-gray-50 dark:bg-dark-700/50">
        <summary class="cursor-pointer p-4 text-sm font-semibold text-gray-900 dark:text-dark-50">
