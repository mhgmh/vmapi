...
<template>
  <div class="flex h-full min-w-0 flex-col rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700">
    <div
    ...
    >
      <h3 class="flex min-w-0 items-center gap-2 text-sm font-bold text-gray-900 dark:text-dark-50">
