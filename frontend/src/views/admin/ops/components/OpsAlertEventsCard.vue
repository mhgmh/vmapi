...
<template>
  <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700">
    <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
      <div>
        <h3 class="text-sm font-bold text-gray-900 dark:text-dark-50">{{ t('admin.ops.alertEvents.title') }}</h3>
      ...
      <div class="max-h-[600px] overflow-y-auto" @scroll="onScroll">
        <div v-if="!isDesktopViewport" class="divide-y divide-gray-100 dark:divide-dark-800">
          ...
          >
            ...
            <div class="text-xs font-semibold text-gray-900 dark:text-dark-50">{{ row.title || '-' }}</div>
      ...
      <div v-else class="space-y-5">
        <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-900">
          <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <div class="mt-2 text-sm font-semibold text-gray-900 dark:text-dark-50">
                {{ selected.title || '-' }}
              </div>
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-900">
              ...
              <div class="mt-1 text-sm font-medium text-gray-900 dark:text-dark-50">{{ formatDateTime(selected.fired_at || selected.created_at) }}</div>
            </div>
            <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-900">
              <div class="text-xs font-bold uppercase tracking-wider text-gray-400">{{ t('admin.ops.alertEvents.detail.resolvedAt') }}</div>
              <div class="mt-1 text-sm font-medium text-gray-900 dark:text-dark-50">{{ selected.resolved_at ? formatDateTime(selected.resolved_at) : '-' }}</div>
            </div>
            <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-900">
              <div class="text-xs font-bold uppercase tracking-wider text-gray-400">{{ t('admin.ops.alertEvents.detail.ruleId') }}</div>
              <div class="mt-1 flex flex-wrap items-center gap-2">
                <div class="font-mono text-sm font-bold text-gray-900 dark:text-dark-50">#{{ selected.rule_id }}</div>
                <a
            ...
            <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-900">
              ...
              <div class="mt-1 text-sm text-gray-900 dark:text-dark-50">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-dark-700 dark:bg-dark-800">
          <div class="mb-3 flex flex-wrap items-center justify-between gap-3">
            <div>
              <div class="text-sm font-bold text-gray-900 dark:text-dark-50">{{ t('admin.ops.alertEvents.detail.historyTitle') }}</div>
