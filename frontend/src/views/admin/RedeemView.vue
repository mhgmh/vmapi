  ...
  <AppLayout>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-value="{ value, row }">
            <span class="text-sm font-medium text-gray-900 dark:text-dark-50">
    ...
    <Teleport to="body">
      <div v-if="showGenerateDialog" class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        >
          <h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-dark-50">
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          <h2 class="mb-1 text-lg font-semibold text-gray-900 dark:text-dark-50">
        ...
        <div class="relative z-10 w-full max-w-lg rounded-xl bg-white shadow-xl dark:bg-dark-800">
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                <h2 class="text-base font-semibold text-gray-900 dark:text-dark-50">
