    ...
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="font-mono text-xl font-medium tracking-tight text-emerald-600 dark:text-emerald-400">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-md bg-indigo-50 p-2 dark:bg-indigo-400/10">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-md bg-violet-50 p-2 dark:bg-violet-400/10">
              ...
              <div class="flex-1">
                ...
                <div class="flex items-baseline gap-2">
                  <p class="font-mono text-sm font-medium tracking-tight text-violet-600 dark:text-violet-400">
          ...
          <div class="card p-4">
            <div class="flex items-center gap-3">
              <div class="rounded-md bg-rose-50 p-2 dark:bg-rose-400/10">
        ...
        <div class="card p-4">
          <div class="mb-3 flex items-center justify-between">
            <h2 class="text-sm font-semibold text-gray-900 dark:text-dark-50">
          ...
          <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            >
              ...
              <span class="min-w-0 flex-1">
                <span class="block text-sm font-medium text-gray-900 dark:text-dark-50">
