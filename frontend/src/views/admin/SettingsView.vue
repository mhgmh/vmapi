          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              <template v-else>
                <div class="flex items-center justify-between">
                  <div>
                    <label class="font-medium text-gray-900 dark:text-dark-50">{{
              ...
              <template v-else>
                ...
                >
                  <div class="mb-3 flex items-center gap-2">
                    <span
                      class="text-sm font-medium text-gray-900 dark:text-dark-50"
                    >
                  ...
                  <div class="flex flex-wrap items-center gap-2">
                    ...
                    >
                      <input
                        ...
                        type="text"
                        class="w-full bg-transparent text-sm font-mono text-gray-900 outline-none placeholder:text-gray-400 dark:text-dark-50 dark:placeholder:text-gray-500"
                        :placeholder="
                          t(
            ...
            <div class="space-y-5 p-6">
              ...
              >
                <label
                  ...
                  class="font-medium text-gray-900 dark:text-dark-50"
                >
              ...
              <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
                <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-700">
                  <div class="flex items-start justify-between gap-4">
                    <div>
                      <h3 class="font-medium text-gray-900 dark:text-dark-50">
                        GitHub
                      </h3>
                      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        {{
            ...
            <div class="space-y-6 p-6">
              ...
              <div class="space-y-4">
                ...
                >
                  <div class="flex items-center justify-between gap-4">
                    <div>
                      <div class="font-medium text-gray-900 dark:text-dark-50">
                        {{ authSource.title }}
                      </div>
                      <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="p-6 space-y-4">
                <div>
                  <h3 class="text-base font-semibold text-gray-900 dark:text-dark-50">
          ...
          >
            ...
            >
              <h3
                class="mb-4 text-lg font-semibold text-gray-900 dark:text-dark-50"
              >
        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              ...
              >
                <div>
                  <h3 class="text-sm font-medium text-gray-900 dark:text-dark-50">
                  ...
                  >
                    <div class="mb-3 flex items-center justify-between gap-3">
                      <div class="flex min-w-0 items-center gap-3">
                        ...
                        <div class="min-w-0">
                          <p class="truncate text-sm font-semibold text-gray-900 dark:text-dark-50">
                      ...
                      <div>
                        ...
                        <div class="flex overflow-hidden rounded-lg border border-gray-300 bg-white focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-primary-500 dark:border-dark-600 dark:bg-dark-900">
                          ...
                          <input
                            v-model="doc.id"
                            type="text"
                            class="min-w-0 flex-1 border-0 bg-transparent px-3 py-2 text-sm text-gray-900 outline-none placeholder:text-gray-400 focus:ring-0 dark:text-dark-50 dark:placeholder:text-dark-500"
                  ...
                  <table class="min-w-full divide-y divide-gray-200 dark:divide-dark-700">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-900">
                      ...
                      <tr v-for="entry in affiliateState.entries" :key="entry.user_id">
                        ...
                        <td class="px-3 py-2 text-sm text-gray-900 dark:text-dark-50">{{ entry.email }}</td>
          ...
          <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-dark-900">
            ...
            <div class="space-y-4">
              <div v-if="affiliateModal.mode === 'add'">
                ...
                >
                  <div class="text-sm">
                    <span class="font-medium text-gray-900 dark:text-dark-50">{{ affiliateModal.selectedUser.email }}</span>
        ...
        <div v-show="activeTab === 'email'" class="space-y-6">
          ...
          <div class="card">
            <div
              class="border-b border-gray-100 px-6 py-4 dark:border-dark-700"
            >
              <h3 class="text-base font-medium text-gray-900 dark:text-dark-50">
...
/* ============ 系统设置 Tab 导航 ============ */
.settings-tabs-shell {
  @apply sticky z-20 -mx-1 rounded-lg border border-white/80 bg-white/90 p-1.5 backdrop-blur-xl;
  top: 4.75rem;
  box-shadow:
