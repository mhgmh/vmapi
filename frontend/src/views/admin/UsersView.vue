        ...
        >
          <template #cell-email="{ value }">
            <div class="flex items-center gap-2">
              ...
              <span class="font-medium text-gray-900 dark:text-dark-50">{{ value }}</span>
            </div>
          </template>
          ...
          <template #cell-balance="{ value, row }">
            <div class="flex items-center gap-2">
              <div class="group relative">
                <button
                  class="font-medium text-gray-900 underline decoration-dashed decoration-gray-300 underline-offset-4 transition-colors hover:text-primary-600 dark:text-dark-50 dark:decoration-dark-500 dark:hover:text-primary-400"
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                :class="{ 'bg-gray-100 text-gray-900 dark:bg-dark-700 dark:text-dark-50': activeMenuId === row.id }"
              >
