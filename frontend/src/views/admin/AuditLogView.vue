        ...
        <DataTable :columns="columns" :data="logs" :loading="loading" row-key="id">
          ...
          <template #cell-actor="{ row }">
            <div class="min-w-0 max-w-[220px]">
              <div class="truncate font-medium text-gray-900 dark:text-dark-50" :title="row.actor_email">
                {{ row.actor_email || '—' }}
              </div>
      ...
      <div v-else-if="detail" class="space-y-5 py-2">
        ...
        <div class="rounded-lg border border-gray-200 bg-gray-50/60 p-5 dark:border-dark-700 dark:bg-dark-900/60">
          <div class="flex flex-wrap items-center gap-3">
            ...
            <span class="break-all font-mono text-base font-semibold text-gray-900 dark:text-dark-50">
              {{ detail.action }}
            </span>
          </div>
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
          <div class="rounded-xl bg-gray-50 p-4 dark:bg-dark-900">
            ...
            <div class="mt-1 break-all text-sm font-medium text-gray-900 dark:text-dark-50">
              {{ detail.actor_email || '—' }}
            </div>
