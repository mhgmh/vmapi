        ...
        <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-dark-600 dark:bg-dark-700">
          <div class="flex items-center justify-between gap-4">
            ...
            <div class="text-right">
              <div class="text-2xl font-semibold text-gray-900 dark:text-dark-50">
                {{ qualityReport.score }}
              </div>
          ...
          <table class="min-w-full divide-y divide-gray-200 text-sm dark:divide-dark-700">
            ...
            <tbody class="divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-900">
              <tr v-for="item in qualityReport.items" :key="item.target">
                <td class="whitespace-nowrap px-3 py-2 text-gray-900 dark:text-dark-50">{{ qualityTargetLabel(item.target) }}</td>
        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm dark:divide-dark-700">
          ...
          <tbody class="divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-900">
            <tr v-for="account in proxyAccounts" :key="account.id">
              <td class="px-4 py-2 font-medium text-gray-900 dark:text-dark-50">{{ account.name }}</td>
              <td class="px-4 py-2">
