<template>
  <AuthLayout>
    <div class="space-y-6">
      <!-- Title -->
      <div>
        <h2 class="text-[22px] font-semibold tracking-tight text-gray-900 dark:text-dark-50">
      ...
      <!-- OAuth providers -->
      <div v-if="showOAuthLogin" class="space-y-2.5">
        <EmailOAuthButtons
      ...
      <div v-if="showOAuthLogin" class="flex items-center gap-3">
        <div class="h-px flex-1 bg-gray-200 dark:bg-dark-700"></div>
        <span class="text-[11px] font-medium uppercase tracking-wider text-gray-400 dark:text-dark-500">
