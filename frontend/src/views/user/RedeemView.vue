    ...
    <div class="mx-auto max-w-2xl space-y-6">
      ...
      <div class="card overflow-hidden">
        <div class="px-6 py-8 text-center">
          <div
            class="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-lg bg-primary-50 text-primary-600 dark:bg-primary-400/10 dark:text-primary-400"
          >
            <Icon name="creditCard" size="xl" />
          </div>
          <p class="text-sm font-medium text-gray-500 dark:text-dark-400">{{ t('redeem.currentBalance') }}</p>
          <p class="mt-2 font-mono text-4xl font-medium tracking-tight text-gray-900 dark:text-dark-50">
