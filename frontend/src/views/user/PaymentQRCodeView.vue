<template>
  <AppLayout>
    <div class="mx-auto flex max-w-md flex-col items-center space-y-6 py-8">
      <h2 class="text-xl font-semibold text-gray-900 dark:text-dark-50">
        {{ qrUrl ? scanTitle : t('payment.qr.payInNewWindow') }}
      </h2>
      <div v-if="qrUrl" class="rounded-lg bg-white p-6 shadow-lg dark:bg-dark-800">
      ...
      <div v-else class="text-center">
        ...
        <p class="mt-1 text-2xl font-bold tabular-nums text-gray-900 dark:text-dark-50">{{ countdownDisplay }}</p>
