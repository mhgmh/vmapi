      ...
      <template v-else-if="detail">
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div class="card p-5">
            ...
            <p class="mt-2 text-2xl font-semibold text-gray-900 dark:text-dark-50">
        ...
        <div class="card p-6">
          <h3 class="text-base font-semibold text-gray-900 dark:text-dark-50">{{ t('affiliate.title') }}</h3>
          ...
          <div class="mt-5 grid gap-4 md:grid-cols-2">
            <div class="space-y-2">
              ...
              <div class="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 dark:border-dark-700 dark:bg-dark-900">
                <code class="flex-1 truncate text-sm font-semibold text-gray-900 dark:text-dark-50">{{ detail.aff_code }}</code>
        ...
        <div class="card p-6">
          <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h3 class="text-base font-semibold text-gray-900 dark:text-dark-50">{{ t('affiliate.transfer.title') }}</h3>
        ...
        <div class="card p-6">
          <h3 class="text-base font-semibold text-gray-900 dark:text-dark-50">{{ t('affiliate.invitees.title') }}</h3>
          ...
          <div v-else class="mt-4 overflow-x-auto">
            <table class="w-full min-w-[560px] text-left text-sm">
              ...
              <tbody>
                ...
                >
                  <td class="px-3 py-3 text-gray-900 dark:text-dark-50">{{ item.email || '-' }}</td>
