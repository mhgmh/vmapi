  ...
  <header class="glass sticky top-0 z-30 border-b border-gray-200/50 dark:border-dark-700/50">
    <div class="flex h-14 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <div
          v-if="user"
          class="group relative hidden items-center gap-2 rounded-md border border-primary-200/60 bg-primary-50 px-2.5 py-1 dark:border-primary-400/20 dark:bg-primary-400/10 sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          ...
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-md bg-gradient-to-br from-primary-400 to-primary-600 text-sm font-medium text-white">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
