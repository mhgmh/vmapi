  ...
  <BaseDialog :show="show" :title="t('admin.groups.rateMultipliersTitle')" width="wide" @close="handleClose">
    <div v-if="group" class="space-y-4">
      ...
      <div class="flex flex-wrap items-center gap-3 rounded-lg bg-gray-50 px-4 py-2.5 text-sm dark:bg-dark-700">
        ...
        <span class="font-medium text-gray-900 dark:text-dark-50">{{ group.name }}</span>
        <span class="text-gray-400">|</span>
          ...
          <div class="relative flex-1">
            ...
            >
              ...
              >
                ...
                <span class="text-gray-900 dark:text-dark-50">{{ user.username || user.email }}</span>
              ...
              <table class="w-full min-w-max text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-dark-600">
                  ...
                  >
                    ...
                    <td class="whitespace-nowrap px-3 py-2 text-gray-900 dark:text-dark-50">{{ entry.user_name || '-' }}</td>
