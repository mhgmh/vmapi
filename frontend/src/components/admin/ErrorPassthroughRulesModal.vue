  ...
  >
    <div class="space-y-4">
      ...
      <div v-else-if="rules.length === 0" class="py-8 text-center">
        ...
        <h4 class="mb-1 text-sm font-medium text-gray-900 dark:text-dark-50">
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-dark-700">
          ...
          <tbody class="divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-800">
            <tr v-for="rule in rules" :key="rule.id" class="hover:bg-gray-50 dark:hover:bg-dark-700">
              ...
              <td class="px-3 py-2">
                <div class="font-medium text-gray-900 dark:text-dark-50 text-sm">{{ rule.name }}</div>
    ...
    >
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <div class="rounded-lg border border-gray-200 p-3 dark:border-dark-600">
          <h4 class="mb-2 text-sm font-medium text-gray-900 dark:text-dark-50">
