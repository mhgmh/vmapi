<template>
  ...
  >
    <div class="space-y-5">
      ...
      <div class="grid gap-4 md:grid-cols-[minmax(0,1fr)_240px]">
        ...
        <aside class="space-y-3 rounded-lg border border-gray-200 bg-gray-50 p-4 text-sm dark:border-dark-700 dark:bg-dark-900/60">
          <div>
            ...
            <p class="mt-1 break-all font-mono text-gray-900 dark:text-dark-50">
      ...
      <div class="space-y-3">
        <label for="admin-compliance-phrase" class="block text-sm font-semibold text-gray-900 dark:text-dark-50">
...
.legal-document-content :deep(h1) {
  @apply mb-4 text-2xl font-bold text-gray-950 dark:text-dark-50;
}

.legal-document-content :deep(h2) {
  @apply mb-3 mt-6 text-xl font-semibold text-gray-900 dark:text-dark-50;
}
...
.legal-document-content :deep(strong) {
  @apply font-semibold text-gray-950 dark:text-dark-50;
}
</style>
