<template>
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    <div class="card p-4 flex items-center gap-3">
      <div class="rounded-md bg-blue-50 p-2 dark:bg-blue-400/10 text-blue-600">
    ...
    <div class="card p-4 flex items-center gap-3">
      <div class="rounded-md bg-amber-50 p-2 dark:bg-amber-400/10 text-amber-600"><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" /></svg></div>
      <div>
        ...
        <p class="flex flex-wrap items-center gap-x-1 text-xs text-gray-500">
          ...
          <span class="group relative inline-flex cursor-help items-center gap-0.5" tabindex="0">
            ...
            >
              <span class="mb-2 block font-medium text-gray-900 dark:text-dark-50">
                {{ cacheDetailLabel() }}
              </span>
    ...
    <div class="card p-4 flex items-center gap-3">
      <div class="rounded-md bg-emerald-50 p-2 dark:bg-emerald-400/10 text-green-600">
    ...
    <div class="card p-4 flex items-center gap-3">
      <div class="rounded-md bg-purple-50 p-2 dark:bg-purple-400/10 text-purple-600">
