    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex flex-wrap rounded-lg bg-gray-100 p-1 dark:bg-dark-700" data-tour="account-form-platform">
          ...
          <button
            type="button"
            data-testid="account-platform-seedance"
      ...
      <div v-if="form.platform === 'seedance'">
        ...
        <div class="mt-2 grid grid-cols-1 gap-3" data-tour="account-form-type">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-gray-900 dark:text-white">API Key</span>
              <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('admin.accounts.types.seedanceApiKey') }}</span>
            </div>
          </button>
        </div>
        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
          {{ t('admin.accounts.seedance.apiKeyOnlyHint') }}
        </p>
      </div>
...
const baseUrlHint = computed(() => {
  ...
  if (form.platform === 'seedance') return t('admin.accounts.seedance.apiKeyOnlyHint')
