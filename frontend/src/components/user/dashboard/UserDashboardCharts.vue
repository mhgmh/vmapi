  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
      ...
      <div class="card relative overflow-hidden p-4">
        ...
        <h3 class="mb-4 text-sm font-semibold text-gray-900 dark:text-dark-50">{{ t('dashboard.modelDistribution') }}</h3>
            ...
            <table class="w-full text-xs">
              ...
              <tbody>
                <tr v-for="model in models" :key="model.model" class="border-t border-gray-100 dark:border-dark-700">
                  <td class="max-w-[100px] truncate py-1.5 font-medium text-gray-900 dark:text-dark-50" :title="model.model">{{ model.model }}</td>
