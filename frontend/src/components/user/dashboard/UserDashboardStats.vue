<template>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div v-if="!isSimple" class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-md bg-emerald-50 p-2 dark:bg-emerald-400/10">
        ...
        <div>
          ...
          <p class="font-mono text-xl font-medium tracking-tight text-emerald-600 dark:text-emerald-400">${{ formatBalance(balance) }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-md bg-blue-50 p-2 dark:bg-blue-400/10">
          <Icon name="key" size="md" class="text-blue-600 dark:text-blue-400" :stroke-width="2" />
        </div>
        <div>
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.apiKeys') }}</p>
          <p class="font-mono text-xl font-medium tracking-tight text-gray-900 dark:text-dark-50">{{ stats?.total_api_keys || 0 }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="font-mono text-xl font-medium tracking-tight text-gray-900 dark:text-dark-50">{{ stats?.today_requests || 0 }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-md bg-purple-50 p-2 dark:bg-purple-400/10">
          <Icon name="dollar" size="md" class="text-purple-600 dark:text-purple-400" :stroke-width="2" />
        </div>
        <div>
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayCost') }}</p>
          <p class="font-mono text-xl font-medium tracking-tight text-gray-900 dark:text-dark-50">
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-md bg-amber-50 p-2 dark:bg-amber-400/10">
          <Icon name="cube" size="md" class="text-amber-600 dark:text-amber-400" :stroke-width="2" />
        </div>
        <div>
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayTokens') }}</p>
          <p class="font-mono text-xl font-medium tracking-tight text-gray-900 dark:text-dark-50">{{ formatTokens(stats?.today_tokens || 0) }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="font-mono text-xl font-medium tracking-tight text-gray-900 dark:text-dark-50">{{ formatTokens(stats?.total_tokens || 0) }}</p>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="font-mono text-xl font-medium tracking-tight text-gray-900 dark:text-dark-50">{{ formatTokens(stats?.rpm || 0) }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="font-mono text-xl font-medium tracking-tight text-gray-900 dark:text-dark-50">{{ formatDuration(stats?.average_duration_ms || 0) }}</p>
  ...
  <div v-if="!isSimple && platformCards.length > 0" class="card p-4">
    <div class="mb-3 flex items-center justify-between">
      <h3 class="text-sm font-semibold text-gray-900 dark:text-dark-50">{{ t('dashboard.platformBreakdown') }}</h3>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
      ...
      >
        <div class="flex items-center justify-between">
          <span class="text-sm font-semibold text-gray-900 dark:text-dark-50">
        ...
        <div class="mt-2 space-y-1 text-xs">
          <div class="flex items-center justify-between">
            ...
            <span class="font-mono text-gray-900 dark:text-dark-50">${{ formatCost(item.today_actual_cost) }}</span>
          </div>
          <div class="flex items-center justify-between">
