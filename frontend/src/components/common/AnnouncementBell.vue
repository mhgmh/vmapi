  ...
  <div>
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        ...
        >
          <div
            class="w-full max-w-[620px] overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black/5 dark:bg-dark-800 dark:ring-white/10"
            @click.stop
          >
    ...
    <Teleport to="body">
      <Transition name="modal-fade">
        ...
        >
          <div
            class="w-full max-w-[780px] overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black/5 dark:bg-dark-800 dark:ring-white/10"
            @click.stop
          >
