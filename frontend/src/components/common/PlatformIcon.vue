<template>
  ...
  <!-- Seedance / Binghuo logo (flame / video mark) -->
  <svg v-else-if="platform === 'seedance'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2c1.8 3.2 4.5 5.1 4.5 8.2A4.5 4.5 0 0 1 12 14.7 4.5 4.5 0 0 1 7.5 10.2C7.5 7.1 10.2 5.2 12 2z" />
    <path d="M7 16.5h10a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2zm3.2 1.2v2.6l3.6-1.3-3.6-1.3z" />
  </svg>
