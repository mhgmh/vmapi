...
func (a *Account) IsSeedanceAPIKey() bool {
	return a.IsSeedance() && a.Type == AccountTypeAPIKey
}
...
// GetSeedanceBaseURL returns the Binghuo/Seedance OpenAI-compatible base URL.
// Prefer credentials.base_url; fall back to the official Binghuo host.
...
// GetSeedanceAPIKey returns the API key used as Authorization Bearer for Seedance.
